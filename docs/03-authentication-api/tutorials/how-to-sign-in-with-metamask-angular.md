...
1. Follow the [Your First Dapp - Angular](/web3-data-api/getting-started/backend-sdks/connect-angular-client) tutorial to set up your Angular dapp and server
