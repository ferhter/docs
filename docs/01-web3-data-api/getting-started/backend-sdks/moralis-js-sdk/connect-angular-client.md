...
[Follow this tutorial](/web3-data-api/getting-started/backend-sdks/create-nodejs-dapp) for setting up your server. We will need a server to use the Moralis API without needing to expose our API key on the client side.
